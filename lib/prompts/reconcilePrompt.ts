...
TITLE MATERIAL RULES (STRICT, NON-NEGOTIABLE)
Materials are usually low buyer-intent in titles. Apply these rules exactly:
NEVER include material percentages in the title
Example: “65% Polyester 35% Rayon” → ❌ forbidden
NEVER include any token containing the word “blend”
Examples: “Cotton Blend”, “Polyester Blend” → ❌ forbidden

NEVER include these base/cheap materials in the title, even if detected:
Cotton
Polyester
Rayon
Acrylic
...
Stretch normalization (allowed exception)
If Spandex OR Elastane OR Lycra is explicitly detected from tags/labels/text:
You MAY include one single token: “Stretch”
Do NOT include the words Spandex / Elastane / Lycra themselves
Do NOT invent Stretch if no explicit evidence exists

High-value materials MAY be included in the title only if explicitly supported by evidence:
Wool
Cashmere
Silk
Linen
...
Angora
Mohair
If there is any uncertainty, omit material from the title.

Material rules apply only to the title.
Item specifics material handling remains unchanged.

FASHION STYLE / THEME KEYWORDS (FASHION ONLY, EVIDENCE-GATED)
Style and theme keywords can be high buyer-intent only for fashion categories.

Apply these rules strictly:

Only apply when the category path clearly indicates fashion (apparel, shoes, bags, accessories).
You may include at most ONE style or theme keyword in the title.
A style/theme keyword may be included only if ALL conditions are met:
The value comes directly from an eBay aspect’s allowed options (Theme / Style / Occasion, etc.) provided to you.
The visual or textual evidence is extremely strong and explicit (not vibes).
The keyword improves buyer search intent without displacing higher-priority tokens.
Do NOT invent, freestyle, or infer style words.
Do NOT include multiple aesthetic buzzwords.
If confidence is not extremely high, omit style from the title.

PREOWNED TITLE EXAMPLES
Evening Dresses: "Reformation Juliette Dress Women's Size 6 Black Midi Silk Blend Cocktail Party"
Designer Pieces: "Gucci Marmont Matelasse Leather Belt Bag Black Gold Hardware Crossbody Authentic"
Denim: "Levi's 501 Original Fit Women's Jeans Size 28x30 Light Wash Vintage Distressed"
Activewear: "Lululemon Align High Rise Leggings Size 6 Black Nulu 25 Inch Full Length Yoga"
Vintage Fashion: "Vintage 1980s Oversized Denim Jacket Women's M Acid Wash Boyfriend Style Retro"
Handbags: "Coach Madison Pebbled Leather Tote Bag Brown Shoulder Purse Zip Top Authentic"

**MEN'S CLOTHING**

Shirts: "Polo Ralph Lauren Custom Fit Oxford Shirt Men's Large Blue White Striped Cotton"
Outerwear: "Patagonia Better Sweater Quarter Zip Fleece Men's Medium Navy Blue Jacket Layer"
Sneakers: "Nike Air Jordan 1 Retro High OG Men's Size 10.5 Black Toe White Red 2016 Release"
Suits: "Hugo Boss Wool Suit 42R Charcoal Gray Two Button Single Breast Super 120s Jacket"
Jeans: "Diesel Thavar Slim Skinny Jeans Men's 32x32 Dark Wash Stretch Denim Italian"

**ELECTRONICS & TECH (22% of Pre-Owned)**

Smartphones: "Apple iPhone 12 Pro 128GB Pacific Blue Unlocked A2341 5G AT&T T-Mobile Verizon"
Laptops: "Dell Latitude 7490 14 Inch Laptop Intel i5 8th Gen 8GB RAM 256GB SSD Windows 11"
Gaming Consoles: "Sony PlayStation 4 Pro 1TB Console CUH-7215B Black with Controller HDMI Cables"
Tablets: "Apple iPad Air 4th Generation 64GB WiFi 10.9 Inch Space Gray 2020 Model A2316"
Smartwatches: "Apple Watch Series 6 44mm Space Gray Aluminum GPS Sport Band Black Health Fitness"
Cameras: "Canon EOS Rebel T7 DSLR Camera 24.1MP with 18-55mm Lens Kit Battery Charger Strap"
Gaming Accessories: "Xbox Elite Wireless Controller Series 2 Black for Xbox One Series X S PC Paddles"
Fiction Hardcover: "Harry Potter Complete Series Box Set JK Rowling Hardcover 1-7 Bloomsbury UK First"
Textbooks: "Campbell Biology 12th Edition Hardcover Urry Cain 2020 College Textbook AP Study"
Collectible Books: "To Kill a Mockingbird Harper Lee First Edition 1960 Hardcover with Dust Jacket"
Paperback Series:
...
Examples: "100 percent Acrylic", "Acrylic", "Acrylic blend" -> "Acrylic" if that is an option.
...
If multiple fibers are present, use your judgement:Use a blend option like "Wool Blend", "Cotton Blend", "Polyester Blend" when it exists.
If there is no good blend option, choose the most important fiber.

High end fibers: If you see Cashmere, Merino, Mohair, Angora, Silk, Linen and there is a matching option, prefer that option.
