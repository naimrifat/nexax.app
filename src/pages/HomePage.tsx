...
      setListingData(finalListingData); // drive UI

      // IMPORTANT: Now, ONLY run the fetch/merge logic if the category is present.
...
          startTransition(() => {
            setEbaySpecifics(cached);
              // Merge AI's specific values back in case they were edited
