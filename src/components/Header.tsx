      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <NavLink to="/upload" label="Create Listing" icon={<Upload className="w-4 h-4" />} active={location.pathname === '/upload'} />
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white absolute top-full left-0 w-full shadow-md animate-fade-in">
          <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
            ...
            <MobileNavLink to="/upload" label="Create Listing" icon={<Upload className="w-5 h-5" />} active={location.pathname === '/upload'} />
